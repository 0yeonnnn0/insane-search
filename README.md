...
> Hermes adaptation: the `hermes-adaptation` branch of this fork adapts the original `fivetaku/insane-search` project for Hermes Agent. See [`HERMES_ADAPTATION.md`](HERMES_ADAPTATION.md) for details.
